...
const codctaInput = document.getElementById("codcta");
const imailInput = document.getElementById("imail");
const montInput = document.getElementById("mont");
...
contiBtn.addEventListener("click", () => {
    if (codctaInput.value === "" || imailInput.value === "" || montInput.value === "") {
